...
<head>
    ...
    <title>@yield('title', 'Get quality notes in one place')</title>
  ...
  <body>
  <noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=G-K08LVCH03Q"
    ...
    <script src="{{ asset('js/hide-payment-search.js') }}"></script>
  </body>
</html>
