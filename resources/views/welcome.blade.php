          ...
          <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
              <figure class="max-w-screen-md mx-auto">
                  ...
                  <blockquote>
                      <p class="text-lg mb:text-2xl font-medium text-gray-900 dark:text-white">"As a post graduate student, I believe Studymerit.com provides a great deal of content on the site with an excellent customer service too
                        "</p>
                  </blockquote>
                  <figcaption class="flex items-center justify-center mt-6 space-x-3">
          ...
          <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
              <figure class="max-w-screen-md mx-auto">
                  ...
                  <blockquote>
                      <p class="text-lg mb:text-2xl font-medium text-gray-900 dark:text-white">"I got to know of Studymerit from a class mate who had used the site before, I uploaded my notes from a medical class and within a day, I had sold all but one. The site is quit useful to anyone who has quality class content."</p>
                  </blockquote>
                  <figcaption class="flex items-center justify-center mt-6 space-x-3">
          ...
          <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
              <figure class="max-w-screen-md mx-auto">
                  ...
                  <blockquote>
                      <p class="text-lg mb:text-2xl font-medium text-gray-900 dark:text-white">"I think Studymerit is a great way to share your work and help others, while also earning money for your efforts. I believe it's a very useful tool."</p>
                  </blockquote>
                  <figcaption class="flex items-center justify-center mt-6 space-x-3">
