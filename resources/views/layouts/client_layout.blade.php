            ...
            <div class="h-full mt-6 px-3 pb-4 pt-10 overflow-y-auto bg-blue-800 dark:bg-gray-800">
                ...
                <li>
                    <a href="{{url('home')}}" class="mb-4 lg:text-xl md:lg sm:text-sm flex items-center p-2 text-gray-100 rounded-lg dark:text-white hover:bg-gray-900 dark:hover:bg-gray-700 group">
                        <svg class="w-8 h-8 text-white transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                ...
                <li>
                    <a href="{{url('uploads')}}" class=" mb-4 lg:text-xl md:lg sm:text-sm flex items-center p-2 text-gray-100 rounded-lg dark:text-white hover:bg-gray-900 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-8 h-8 text-white transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                ...
                <li>
                    <a href="{{url('downloads')}}" class=" mb-4 lg:text-xl md:lg sm:text-sm flex items-center p-2 text-gray-100 rounded-lg dark:text-white hover:bg-gray-900 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">My Downloads</span>
                    </a>
                </li>
                <li>
                    <a href="{{url('earnings')}}" class="mb-4 lg:text-xl md:lg sm:text-sm flex items-center p-2 text-gray-100 rounded-lg dark:text-white hover:bg-gray-900 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-8 h-8 text-white transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                ...
                <li>
                    <a href="#" class="lg:text-xl md:lg sm:text-sm flex items-center p-2 text-gray-100 rounded-lg dark:text-gray-900 hover:bg-gray-900 dark:hover:bg-gray-700 group">
