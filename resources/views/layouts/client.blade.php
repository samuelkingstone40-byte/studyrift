...
<html lang="en">
  ...
  <body >
        ...
        <div class="container-xl">
          ...
          <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item d-none d-md-flex me-3">
              <div class="btn-list">
                <a href="https://github.com/tabler/tabler" class="btn text-dark" target="_blank" rel="noreferrer">
   ...
   <polyline points="9 19 12 22 15 19"></polyline>
    ...
    <script src="{{asset('theme/dist/libs/jsvectormap/dist/js/jsvectormap.min.js')}}" ></script>
    <script src="{{asset('theme/dist/libs/jsvectormap/dist/maps/world.js')}}" ></script>
    <script src="{{asset('theme/dist/libs/jsvectormap/dist/maps/world-merc.js')}}" ></script>
    <script src="https://cdn.datatables.net/1.10.21/js/jquery.dataTables.min.js"></script>
<script src="https://cdn.datatables.net/1.10.21/js/dataTables.bootstrap4.min.js"></script>
    <!-- Tabler Core -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.2.228/pdf.min.js"></script>

    <script src="{{asset('theme/dist/js/tabler.min.js')}}" ></script>
    <script src="{{asset('theme/dist/js/demo.min.js')}}"></script>
