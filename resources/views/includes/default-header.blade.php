<nav class="bg-white border-b border-gray-200  py-2 mb-5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
    <div class=" flex flex-wrap  justify-between items-center px-4">
        <div class="flex items-center justify-start">
          
            <a href="{{url('/')}}" class="flex ml-2 md:mr-24">
                <img class="w-16 xs:w-32 sm:w-32 md:w-48 lg:w-64 " src="{{asset('theme/img/site/logo.png')}}" alt="" />
            </a>
        </div>

        <div class="flex items-center md:order-2">
            @guest
                <a href="{{url('login')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg xs:text-sm  sm:text-sm  md:text-lg px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</a>
                <a href="{{url('register')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg sm:text-sm md:text-lg px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</a>
            @else
            ...
            @endguest
            <button data-drawer-target="navbar-language" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
